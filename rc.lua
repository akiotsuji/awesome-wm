...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Each screen has its own tag table.(default->"1--9")
...
globalkeys = gears.table.join(
    ...
    awful.key({ "Mod1", "Control" }, "[",   awful.tag.viewprev,
              {description = "view previous", group = "tag"}),
    awful.key({ "Mod1", "Control" }, "]",  awful.tag.viewnext,
    ...
    awful.key({                   }, "XF86AudioMute",
              function ()
                  awful.util.spawn("amixer sset Master 100%-")
    ...
    awful.key({ "Control",  "Mod1"   }, "Return", function () awful.util.spawn("google-chrome") end),
...
awful.rules.rules = {
    ...
    -- if you want to remove each titlebar--false
    -- if you want a titlebar--true
